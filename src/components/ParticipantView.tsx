      ...
      >
        ...
        <p className="text-sm text-white ml-0.5">
          {isPresenting
            ...
            : isLocal
            ? `${nameTructed(displayName, 26)} (you)`
                      ...
                      {ReactDOM.createPortal(
                        ...
                        >
                          <div
                            ...
                            className="rounded-2xl shadow-lg ring-1 ring-black ring-opacity-5 "
                          >
                            <div
...
export function ParticipantView({ participantId }: ParticipantViewProps) {
  ...
  useEffect(() => {
    console.log("participantId", participantId)
      ...
      const unsubscribe = onSnapshot(roomMembersCollection, (snapshot) => {
        ...
        const filteredAvatarUrl = data.find(item => item.user_id === +participantId)?.avatar_url;
        setAva(filteredAvatarUrl);
      });
  ...
  return mode === "CONFERENCE" ? (
    <div
      ...
      className={`h-full w-full relative overflow-hidden rounded-2xl video-cover`}
    >
      ...
      {webcamOn ? (
        ...
        <div className="h-full w-full flex items-center justify-center">
          <Avatar radius="50%" size={100} src={ava}></Avatar>
          {/* <div
            style={{ backgroundColor: "rgb(117, 117, 117)" }}
            className={`z-10 flex items-center justify-center rounded-full 2xl:h-[92px] h-[52px] 2xl:w-[92px] w-[52px]`}
          >
